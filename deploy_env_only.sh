...
# Frontend Student Base URL (per link registrazione gruppo) - RICHIESTA INTERATTIVA
DEFAULT_FRONTEND_STUDENT_URL="http://${SERVER_IP}/studenti/" # Default basato su IP e path comune
read -p "URL base Frontend Studente (per link registrazione) [${DEFAULT_FRONTEND_STUDENT_URL}]: " FRONTEND_STUDENT_BASE_URL_VAR
FRONTEND_STUDENT_BASE_URL_VAR=${FRONTEND_STUDENT_BASE_URL_VAR:-${DEFAULT_FRONTEND_STUDENT_URL}}
...
FRONTEND_STUDENT_BASE_URL=${FRONTEND_STUDENT_BASE_URL_VAR} # Aggiunta variabile dall'input utente
