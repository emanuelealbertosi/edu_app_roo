    ...
    <div class="bg-white rounded-lg shadow-xl p-6 w-full max-w-md">
      ...
      <div class="mb-4">
        ...
        <input 
          ...
          placeholder="Es. Lezioni di Algebra Lineare"
        />
      </div>
...
import type { LessonGroup } from '@/types/lezioni';

const props = defineProps<{
  show: boolean;
  existingGroup?: LessonGroup | null;
}>();
...
watch(() => props.existingGroup, (newGroup) => {
  groupName.value = newGroup ? newGroup.name : '';
});
