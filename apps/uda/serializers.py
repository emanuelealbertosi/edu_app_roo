...
class UDASerializer(serializers.ModelSerializer):
   ...
   def update(self, instance, validated_data):
        ...
        instance.is_civic_education = validated_data.get('is_civic_education', instance.is_civic_education)
        instance.didactic_strategies_html = validated_data.get('didactic_strategies_html', instance.didactic_strategies_html)
